  ...
  <div id="menu-list" class="gm-3 wrapper">
    ...
    foreach ($menus as $name) {
      if ($name[0]!='.') {
        ...
        echo '<li><a href="'.Gila\Gila::make_url('admin', 'menu').$lname.'">'.$lname.'</a>';
      }
    }
    ?>
    </ul>
    ...
    <div>
      ...
      <button class="g-btn fullwidth" onclick="window.location.href='<?=Gila\Gila::make_url('admin', 'menu')?>'+g('#new-menu').all[0].value"><?=__("New")?></button>
    </div>
  </div>
</div>
