...
$files=[];
if($path=='src') {
  $scanned = scandir('src/core/assets/');
  foreach($scanned as $i=>$v){ $scanned[$i] = 'src/core/assets/'.$scanned[$i];}
...
<a class='btn btn-white g-group-item' id='fm-goup' data-path='src' <?=$disabled?>>
