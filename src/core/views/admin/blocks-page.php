...
<div style="height:4vh;display:flex;border-bottom:1px solid grey;justify-content: space-between;
align-items: center;padding:0 1em">
  ...
  function tabletView() {
    pageFrame.style.width = '800px'
    pageFrame.style.height = '80vh'
    pageFrame.style.marginTop = '3em'
    pageFrame.style.borderRadius = '1em'
    pageFrame.style.border = '1em solid silver';
  }
  function mobileView() {
    pageFrame.style.width = '300px'
...
<div style="background:#eee;display:flex;justify-content:center;height:95vh">
  <iframe style="width:100%;height:95vh;border:0;transition:0.3s" id=pageFrame src='<?=Config::base()?>blocks/display?t=page&id=<?=htmlentities($id)?>'>
</div>
