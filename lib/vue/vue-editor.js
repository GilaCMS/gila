...
var mydata={
	buttons_def:{
        ...
        img:{label:"<i class='fa fa-image'></i>",action:"insertNode",args:['FIGURE','<img src="assets/gila-logo.png" ><figcaption>Image Caption</figcaption>',false]},
	...
	buttons_i:['h1','h2','bold','italian','ins','del','blockquote','unset','ul','ol','aleft','amiddle','aright','img','code','p'],
    node_buttons:{
